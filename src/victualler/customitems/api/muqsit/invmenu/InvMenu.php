...
namespace victualler\customitems\api\muqsit\invmenu;

use Closure;
use victualler\customitems\api\muqsit\invmenu\inventory\SharedInvMenuSynchronizer;
...
use victualler\customitems\api\muqsit\invmenu\transaction\DeterministicInvMenuTransaction;
use victualler\customitems\api\muqsit\invmenu\transaction\InvMenuTransaction;
use victualler\customitems\api\muqsit\invmenu\transaction\InvMenuTransactionResult;
use victualler\customitems\api\muqsit\invmenu\transaction\SimpleInvMenuTransaction;
use victualler\customitems\api\muqsit\invmenu\type\InvMenuType;
use victualler\customitems\api\muqsit\invmenu\type\InvMenuTypeIds;
use LogicException;
...
class InvMenu implements InvMenuTypeIds{
	...
	/**
	 * @return \victualler\customitems\api\muqsit\invmenu\type\InvMenuType
	...
	/**
	 * @param (Closure(\victualler\customitems\api\muqsit\invmenu\transaction\InvMenuTransaction) : InvMenuTransactionResult)|null $listener
	 * @return self
	 */
